...
const BadgeSVG = () => (
  <svg viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg" className="trust__visual">
    ...
    <g filter="url(#rf-badge)">
      {/* outer dashed ring */}
      <circle cx="120" cy="120" r="112" stroke="rgb(43,26,7)" strokeWidth="2" strokeDasharray="6 5" />
      {/* inner solid ring */}
      <circle cx="120" cy="120" r="96" stroke="rgb(43,26,7)" strokeWidth="2.5" />
      ...
      <text fontSize="13" fontWeight="800" fill="rgb(43,26,7)"
      ...
      <path
        ...
        fill="rgb(255,111,30)" fillOpacity="0.15"
        stroke="rgb(43,26,7)" strokeWidth="3" strokeLinejoin="round"
      />

      {/* checkmark – thick, rounded */}
      <path
        d="M 96,122 L 113,140 L 148,96"
        stroke="rgb(43,26,7)" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"
      />

      {/* orange diamond separators at 4 compass points */}
      <polygon points="120,10 117,14 120,18 123,14" fill="rgb(255,111,30)" />
      <polygon points="120,222 117,226 120,230 123,226" fill="rgb(255,111,30)" />
      <polygon points="10,120 6,117 10,114 14,117" fill="rgb(255,111,30)" />
      <polygon points="230,120 226,117 230,114 234,117" fill="rgb(255,111,30)" />
    </g>
  </svg>
)
  ...
  <svg viewBox="0 0 200 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="trust__visual">
    ...
    <g filter="url(#rf-lock)">
      ...
      <path
        ...
        stroke="rgb(43,26,7)" strokeWidth="14" strokeLinecap="round"
        fill="none"
      />
      {/* shackle inner highlight so it reads as a bar not a blob */}
      <path
        d="M 54,112 L 54,66 Q 54,24 100,24 Q 146,24 146,66 L 146,112"
        stroke="rgb(253,251,249)" strokeWidth="5" strokeLinecap="round"
        fill="none" opacity="0.35"
      />

      {/* ── Lock body ── */}
      <rect x="20" y="104" width="160" height="110" rx="22"
        fill="rgb(253,251,249)" stroke="rgb(43,26,7)" strokeWidth="3.5" />

      {/* ── Keyhole: circle + slot ── */}
      {/* outer circle (orange accent ring) */}
      <circle cx="100" cy="148" r="24"
        fill="rgb(255,111,30)" fillOpacity="0.12"
        stroke="rgb(43,26,7)" strokeWidth="3" />
      {/* filled dark centre */}
      <circle cx="100" cy="148" r="11" fill="rgb(43,26,7)" />
      {/* slot below */}
      <rect x="93" y="157" width="14" height="28" rx="5" fill="rgb(43,26,7)" />
...
const CoffeeSVG = () => (
  <svg viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="trust__visual">
    ...
    <g filter="url(#rf-coffee)">
      ...
      {/* main block */}
      <rect x="38" y="100" width="60" height="72" rx="3" fill="rgb(200,190,175)" stroke="rgb(43,26,7)" strokeWidth="2" />
      {/* windows */}
      ...
      {/* door */}
      <rect x="59" y="148" width="14" height="24" rx="2" fill="rgb(43,26,7)" fillOpacity="0.35" />
      {/* tower */}
      <rect x="60" y="60" width="18" height="42" fill="rgb(215,205,190)" stroke="rgb(43,26,7)" strokeWidth="1.8" />
      {/* spire – orange tip */}
      <polygon points="69,36 58,62 80,62" fill="rgb(255,111,30)" />
      {/* clock */}
      <circle cx="69" cy="76" r="6" fill="rgb(253,251,249)" stroke="rgb(43,26,7)" strokeWidth="1.5" />
      <line x1="69" y1="76" x2="69" y2="71" stroke="rgb(43,26,7)" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="69" y1="76" x2="73" y2="76" stroke="rgb(43,26,7)" strokeWidth="1.5" strokeLinecap="round" />

      {/* ground line */}
      <line x1="22" y1="172" x2="198" y2="172" stroke="rgb(43,26,7)" strokeWidth="2.5" strokeLinecap="round" />

      {/* ── Coffee cup (foreground, right side) ── */}
      {/* steam */}
      <path d="M 148,68 C 148,58 154,58 154,48 C 154,38 160,38 160,28"
        stroke="rgb(43,26,7)" strokeWidth="2.5" strokeLinecap="round" fill="none" />
      <path d="M 162,72 C 162,62 168,62 168,52 C 168,42 174,42 174,32"
        stroke="rgb(43,26,7)" strokeWidth="2.5" strokeLinecap="round" fill="none" />

      {/* cup body */}
      <path d="M 132,80 L 138,162 L 192,162 L 198,80 Z"
        fill="rgb(253,251,249)" stroke="rgb(43,26,7)" strokeWidth="3" strokeLinejoin="round" />
      {/* coffee fill */}
      <path d="M 134,96 L 138,162 L 192,162 L 196,96 Z"
        fill="rgb(43,26,7)" fillOpacity="0.08" />

      {/* handle */}
      <path d="M 195,102 C 215,102 215,140 195,140"
        stroke="rgb(43,26,7)" strokeWidth="3" strokeLinecap="round" fill="none" />

      {/* saucer */}
      <ellipse cx="165" cy="166" rx="42" ry="8"
        fill="rgb(253,251,249)" stroke="rgb(43,26,7)" strokeWidth="2.5" />
